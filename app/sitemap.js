export default function sitemap() {
  ...
  const routes = [
    ...
    { url: `${baseUrl}/services/website-development-services-company`, priority: 0.85 },
    { url: `${baseUrl}/services/android-app-development-services`, priority: 0.85 },
    { url: `${baseUrl}/services/ios-app-development`, priority: 0.85 },
    { url: `${baseUrl}/services/api-development-services`, priority: 0.8 },
    { url: `${baseUrl}/services/blockchain-development-company`, priority: 0.8 },
    { url: `${baseUrl}/services/mobile-game-development-company`, priority: 0.8 },
    ...
    { url: `${baseUrl}/services/erp-crm`, priority: 0.8 },
    { url: `${baseUrl}/services/iot-application-development-services`, priority: 0.8 },
  ];
