...
//         <div className="relative z-10    mx-auto px-[5%] py-20 md: py-12 grid md:grid-cols-2 gap-16 items-center w-full">
//           {/* Left */}
//           <div>
...
//                 <Image //                   src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=900&auto=format&fit=crop" width={800} height={600}
//                   alt="Team working"
...
//       {/* ─── CAPABILITIES ─── */}
//       <section id="capabilities" className="py-12 overflow-hidden"
...
//                         <Image fill src={p.img} alt={p.title} className="w-full object-cover"  />
...
//       {/* ─── CASE STUDIES ─── */}
//       <section id="case-studies" className="py-12 overflow-hidden"
...
//                   <Image fill src={c.img} alt={c.title} className="w-full h-full object-cover" />
//                 </div>
//                 <div>
...
//                     <Image fill src={c.img} alt={c.title} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
