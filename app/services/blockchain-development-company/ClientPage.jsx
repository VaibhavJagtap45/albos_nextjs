    ...
    <div className="relative z-10 max-w-screen-2xl mx-auto px-[5%]">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-14">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-[2.6rem] lg:text-[3rem] font-bold mb-2">
            Blockchain & Web3
          </h1>
          <h1 className="text-3xl sm:text-4xl md:text-[2.6rem] lg:text-[3rem] font-bold  mb-4 bg-gradient-to-r from-blue-700 to-blue-500 bg-clip-text text-transparent">
